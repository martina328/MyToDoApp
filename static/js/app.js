document.addEventListener("DOMContentLoaded", function() {
    ...
    // Overrides the default behavior of the nav links so that we can 
    // Turns on a spinner control when the user clicks on the recommendations tab
    ...
    Array.from(navLinks).forEach((navLink) => {
        navLink.addEventListener('click', function(e) {
            ...
            // Turns on the spinner control if the user clicks on the recommendations tab
    ...
    // The showDetails function will highlight the selected task item and then redirect the user to the Details tab for the selected task.
    ...
    // Adds javascript to support speech recognition for the todo input field
